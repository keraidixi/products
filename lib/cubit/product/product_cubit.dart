    ...
    try {
      ...
      final seedProducts = [
        ProductModel(
          ...
          description: 'Experience titanium design, ground-breaking A17 Pro chip, and the most powerful iPhone camera system ever.',
        ),
        ProductModel(
          id: '2',
          ...
          description: 'The most advanced chips ever built for a personal computer. Phenomenal battery life and a stunning Liquid Retina XDR display.',
        ),
        ProductModel(
          id: '3',
        ...
        ProductModel(
          ...
          description: 'Astonishing performance, incredibly advanced displays, superfast wireless connectivity, and next-level Apple Pencil capabilities.',
        ),
        ProductModel(
          id: '5',
        ...
        ProductModel(
          ...
          description: 'A full metal QMK/VIA custom mechanical keyboard. Beautifully designed CNC aluminum body with premium tactile switches.',
        ),
      ];
